...
const daeguThemes: Record<LocalThemeKey, LocalThemeConfig> = {
  CITY_STORY: {
    ...
    promptDirectives: [
      ...
      '선택 장소를 단순 설명하지 말고 도달쑤가 직접 발견하는 도시 탐험으로 구성한다.',
    ],
  ...
  NATURE_FRIENDSHIP: {
    ...
    title: '도달쑤의 신천과 팔공산',
    description: '도달쑤가 도시 속 자연과 물길을 안내하는 지역 이야기를 만듭니다.',
    topics: ['대구 자연 탐험', '도달쑤의 물길 안내'],
    objectives: ['도시와 자연이 함께 있는 지역 특성을 이해하기', '지역 자연을 아끼는 태도 배우기'],
    moral: '도시와 자연은 서로를 돌볼 때 함께 빛나요.',
    promptDirectives: [
      '도달쑤를 대구 신천을 좋아하는 밝은 수달 안내자로 모든 장면에 등장시킨다.',
      '환경 보호를 훈계하지 말고 도달쑤의 관찰과 행동으로 자연스럽게 보여준다.',
    ],
    requiredAnchors: ['도달쑤', '도시 속 자연'],
  },
};
...
const chungbukThemes: Record<LocalThemeKey, LocalThemeConfig> = {
  CITY_STORY: {
    ...
    requiredAnchors: ['고드미·바르미', '충북', '충북 공공데이터 장소'],
  },
  HERITAGE: {
    id: 'HERITAGE',
    title: '중원문화 탐험',
    description: '충북의 문화유산과 전통을 고드미·바르미가 안내하는 탐험으로 바꿉니다.',
    ...
    requiredAnchors: ['고드미·바르미', '충북 문화유산 정보', '탐험 장면'],
  },
  NATURE_FRIENDSHIP: {
    id: 'NATURE_FRIENDSHIP',
    title: '청풍명월 자연 모험',
    description: '고드미·바르미가 호수와 숲, 산길을 안내하는 맑은 자연 모험 이야기를 만듭니다.',
    topics: ['충북 자연 탐험', '고드미·바르미의 호수 안내'],
    objectives: ['자연과 지역 문화가 이어지는 방식을 이해하기', '지역 자연을 아끼는 태도 배우기'],
    moral: '맑은 자연은 함께 지킬 때 오래 친구가 되어 줘요.',
    promptDirectives: [
      '청풍명월의 맑고 차분한 정서를 호수, 숲, 달빛, 산길 이미지로 표현한다.',
      '자연 보호 메시지는 직접 훈계보다 고드미·바르미의 관찰과 행동으로 보여준다.',
    ],
    requiredAnchors: ['고드미·바르미', '청풍명월', '호수와 숲'],
  },
};
...
export const LOCAL_STORY_REGIONS: Record<LocalRegionSlug, LocalRegionConfig> = {
  ...
  chungbuk: {
    ...
    mascotGenerationEnabled: true,
    mascotUsageNote: '충청북도 공식 대표 캐릭터 참조 이미지 · 공모전 지역 스토리 안내 캐릭터로 사용',
