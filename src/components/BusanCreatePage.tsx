...
const themes = {
  ...
  MULTICULTURAL: {
    label: '부산 다문화 이야기',
    topics: ['부산 다문화 소개', '문화 존중'],
    objectives: ['부산이 다양한 문화를 만나는 도시임을 이해하기', '서로 다른 문화를 존중하는 태도 배우기'],
    moral: '다름은 벽이 아니라 함께 배우는 다리예요.',
    promptDirectives: [
      '부산 공식 캐릭터 부기가 부산의 다문화 공간, 음식, 언어, 축제, 항구 도시의 만남을 소개한다.',
      '다양한 문화권 사람들은 배경의 작은 군중으로만 표현하고 이름 있는 반복 캐릭터를 새로 만들지 않는다.',
    ],
    requiredAnchors: ['부산 공식 캐릭터 부기', '부산 다문화 요소'],
  },
} as const;
